        ...
        <Card className="bg-gray-900 border-yellow-400/20 mb-6">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-white font-medium mb-1">What is a Project Dossier?</h3>
                <p className="text-gray-400 text-sm">
                  The dossier is a running record of your project's state. Update it at each
                  milestone with what you've completed, what remains, technical decisions, and
                  file locations. If the project ever needs to be handed off, this is what the
                  next freelancer reads.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <Card className="bg-gray-900 border-gray-800 mb-8">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                {milestones.length > 0 && (
                  <div>
                    <Label className="text-gray-300">
                      Related Milestone <span className="text-gray-500">(optional)</span>
                    </Label>
                    <select
                ...
                <div>
                  <Label className="text-gray-300">
                    What has been completed <span className="text-red-400">*</span>
                  </Label>
                  <Textarea
                    value={completedWork}
                ...
                <div>
                  <Label className="text-gray-300">
                    What remains to be done <span className="text-red-400">*</span>
                  </Label>
                  <Textarea
                    value={remainingWork}
                ...
                <div>
                  <Label className="text-gray-300">
                    Technical Notes <span className="text-gray-500">(optional)</span>
                  </Label>
                  <Textarea
                ...
                <div>
                  <Label className="text-gray-300">
                    Known Issues & Blockers <span className="text-gray-500">(optional)</span>
                  </Label>
                  <Textarea
                    value={knownIssues}
                ...
                <div>
                  <Label className="text-gray-300">
                    Recommended Next Steps <span className="text-gray-500">(optional)</span>
                  </Label>
                  <Textarea
                    value={nextSteps}
                ...
                <div>
                  <Label className="text-gray-300">
                    Files, Repos & Access Info <span className="text-gray-500">(optional)</span>
                  </Label>
                  <Textarea
        ...
        {dossiers.length === 0 ? (
          <Card className="bg-gray-900 border-gray-800">
            <CardContent className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">No dossier entries yet</h3>
                ...
                <CardContent className="p-5">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-white font-medium text-sm">{entry.author.name}</p>
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="text-green-400 text-xs font-semibold mb-1 flex items-center gap-1">
                        <CheckCircle className="h-3 w-3" /> Completed Work
                      </p>
                      <p className="text-gray-300 text-sm whitespace-pre-wrap">{entry.completedWork}</p>
                    </div>

                    <div>
                      <p className="text-orange-400 text-xs font-semibold mb-1 flex items-center gap-1">
                        <Clock className="h-3 w-3" /> Remaining Work
                      </p>
                      <p className="text-gray-300 text-sm whitespace-pre-wrap">{entry.remainingWork}</p>
                    </div>

                    {entry.technicalNotes && (
                      <div>
                        <p className="text-blue-400 text-xs font-semibold mb-1">Technical Notes</p>
                        <p className="text-gray-300 text-sm whitespace-pre-wrap">{entry.technicalNotes}</p>
                      </div>
                    )}

                    {entry.knownIssues && (
                      <div>
                        <p className="text-red-400 text-xs font-semibold mb-1">Known Issues</p>
                        <p className="text-gray-300 text-sm whitespace-pre-wrap">{entry.knownIssues}</p>
                      </div>
                    )}

                    {entry.nextSteps && (
                      <div>
                        <p className="text-purple-400 text-xs font-semibold mb-1">Next Steps</p>
                        <p className="text-gray-300 text-sm whitespace-pre-wrap">{entry.nextSteps}</p>
                      </div>
                    )}
                    ...
                    {entry.filesAndAccess && (
                      <div>
                        ...
                        <p className="text-gray-300 text-sm whitespace-pre-wrap">{entry.filesAndAccess}</p>
                      </div>
                    )}
                  </div>
                </CardContent>
